...
export default function MissionPage() {
  return <>
    <section className="px-5 pb-8 pt-8 sm:px-8 md:grid md:grid-cols-[1fr_0.82fr] md:items-center md:gap-8 md:py-14">
      <div>
        <p className="inline-flex rounded-full bg-white px-4 py-2 text-sm font-bold uppercase tracking-[0.2em] text-rosette shadow-sm">Bark Booth vision</p>
