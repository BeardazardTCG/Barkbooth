      ...
      <div className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
        <Card className="bg-gradient-to-br from-navy to-cocoa text-white">
          ...
          <div className="grid gap-5 sm:grid-cols-[150px_1fr] sm:items-center">
            <PawAvatar label={`${dog.name} official profile photo placeholder`} className="bg-gradient-to-br from-white via-offwhite to-skysoft text-6xl ring-4 ring-white/20" />
            <div><p className="text-sm font-bold uppercase tracking-[0.2em] text-white/55">Official Bark Booth Identity</p><h1 className="mt-3 text-4xl font-bold leading-none">{dog.name}</h1><p className="mt-3 text-2xl font-bold text-skysoft">{dog.registryNumber}</p><p className="mt-2 font-bold text-white/75">{breedSummary(dog)} · {primaryDogType(dog)}</p></div>
          </div>
