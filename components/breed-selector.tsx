...
export function BreedSelector({ mixedBreed = false }: BreedSelectorProps) {
  return <div className="grid gap-3 rounded-[1.5rem] border border-cocoa/10 bg-white/70 p-4 md:col-span-2">
    <div>
      <label className="font-black text-navy" htmlFor="breed">Breed</label>
      <select id="breed" name="breed" required defaultValue="" className="mt-2 w-full rounded-2xl border border-cocoa/10 bg-white px-4 py-3">
    ...
    <label className="font-black text-navy">Breed mix details <select name="breedMix" multiple size={5} className="mt-2 w-full rounded-2xl border border-cocoa/10 bg-white px-4 py-3">
