...
export default async function DogIdentityPage({ params }: { params: { registryNumber: string } }) {
  ...
  return <><div id="top" />
    ...
    {canManage && <Section eyebrow="Pet profile" title="Pet details"><Card><details><summary className="cursor-pointer text-xl font-bold text-navy">Edit pet details</summary>
