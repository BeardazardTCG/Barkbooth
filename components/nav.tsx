...
type Viewer = { displayName: string; username: string; role: "MEMBER" | "ADMIN" } | null;
const publicLinks = [["Registry", "/profiles"], ["Activities", "/competitions"], ["Professionals", "/professionals"], ["News", "/news"], ["Events", "/events"], ["How it works", "/about"], ["Support", "/support"]];
const appLinks = [["Dashboard", "/dashboard", "home"], ["Professionals", "/professionals", "directory"], ["My Dogs", "/dogs", "dogs"], ["Register Dog", "/register-dog", "plus"], ["Competitions", "/competitions", "award"], ["Support", "/support", "person"]];
const discoveryLinks = [["Public homepage", "/", "globe"], ["Registry", "/profiles", "search"], ["Activities", "/competitions", "award"], ["Directory", "/directory", "directory"], ["News & Events", "/news", "globe"]];
const mobileLinks = [["Dashboard", "/dashboard", "home"], ["Professionals", "/professionals", "directory"], ["My Dogs", "/dogs", "dogs"], ["Register", "/register-dog", "plus"], ["Competitions", "/competitions", "award"], ["Account", "/account", "person"]];
