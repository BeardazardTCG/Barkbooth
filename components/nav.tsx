...
const publicLinks = [["Registry", "/profiles"], ["How it works", "/about"], ["Help", "/faq"]];
const appLinks = [["My Dogs", "/dogs", "dogs"], ["Register Dog", "/register-dog", "plus"], ["Registry", "/profiles", "search"]];
const mobileLinks = [["My Dogs", "/dogs", "dogs"], ["Register", "/register-dog", "plus"], ["Registry", "/profiles", "search"], ["Account", "/account", "person"]];
const footerLinks = [["How it works", "/about"], ["Help", "/faq"], ["Privacy", "/legal/privacy-policy"], ["Terms", "/legal/terms-and-conditions"]];
